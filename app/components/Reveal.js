        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-[var(--md-sys-color-background)]">
            <div className="card max-w-md w-full animate-fade-in relative overflow-hidden">
                ...
                <div className="text-center mb-6">
                    ...
                    <div className={`transition-opacity duration-1000 ${revealStep > currentGift.hints.length ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className="bg-[var(--md-sys-color-surface-variant)] p-6 rounded-xl mb-8 border border-[var(--md-sys-color-outline)]/20">
                    ...
                    <ul className="space-y-2 text-center text-[var(--md-sys-color-on-surface-variant)] italic">
                        {currentGift.hints.map((hint, i) => (
                            <li key={i} className={`transition-opacity duration-1000 ${revealStep > i ? 'opacity-100' : 'opacity-0'}`}>
                                "{hint}"
                            </li>
                        ))}
                    </ul>
                    <div className={`mt-6 pt-4 border-t border-[var(--md-sys-color-outline)]/20 text-center transition-opacity duration-1000 ${revealStep > currentGift.hints.length + 1 ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className={`transition-opacity duration-1000 ${revealStep > currentGift.hints.length + 2 ? 'opacity-100' : 'opacity-0'}`}>
                    {/* Story Prompt */}
                    <div className="mb-8 text-center">
                        <p className="text-[var(--md-sys-color-primary)] font-medium animate-pulse text-lg">
                            {isProvider ? t('reveal.tell_story') : (hasRated ? t('reveal.waiting_completion') : t('reveal.listening'))}
                        </p>
                    </div>
